      ...
      <header className="app-header">
          ...
          <div>
            <div className="app-title">
              NeuralAcademy{' '}
              <span style={{ opacity: 0.7 }}>· Smart Study Hub</span>
            </div>
            <p className="app-subtitle">
              Upload your lecture PDFs and explore an AI-ready study workspace
              that bridges theory and code.
            </p>
          </div>
        ...
        <div className="tag-row">
          <span className="app-badge">phase 1 · pdf lab</span>
          <span className="tag">PDF → Text</span>
          <span className="tag">Study Sheet</span>
          <span className="tag">Coding Playground (coming soon)</span>
        </div>
      </header>
